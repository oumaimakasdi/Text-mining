...
=>Le projet se constitue de 2 fichiers :
   1- Data_Scraping.ipynb
   2- Search_Engine.ipynb

Le premier concerne l'importation des données en utilisant le Web Scraping.
le deuxième concerne la manipulation des données et la création des fonctions demandées.
